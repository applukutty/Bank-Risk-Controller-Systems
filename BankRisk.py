...
#df_modified = pd.read_csv(r"C:\Users\Arun kumar L\Desktop\New folder\df_modified.csv")
df = pd.read_csv("C:\\Users\\Arun kumar L\\Desktop\\New folder\\df_new.csv")


# --------------------------------------------------Logo & details on top

st.set_page_config(page_title= "Bank Risk Controller System | By Arunkumar L",
                   layout= "wide",
...
with st.sidebar:
    ...
    opt = option_menu("Menu",
                    ["Home",'Matrix Insights','EDA','Model Prediction','ML Recommendation system',"About"],
...
# MLRecommendation system tab content
...
if opt == "ML Recommendation system":
    ...
    data = pd.read_csv(r"C:\Users\Arun kumar L\Downloads\mobile_recommendation_system_dataset.csv\mobile_recommendation_system_dataset.csv")
